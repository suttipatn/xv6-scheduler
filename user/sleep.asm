...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b2:	45250513          	addi	a0,a0,1106 # 800 <digits>
 3b6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47e:	386b8b93          	addi	s7,s7,902 # 800 <digits>
 ...
 5be:	23e90913          	addi	s2,s2,574 # 7f8 <malloc+0xf8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 686:	1967b783          	ld	a5,406(a5) # 818 <freep>
 ...
 6b4:	00e6ea63          	bltu	a3,a4,6c8 <free+0x50>
{
 ...
 6f6:	12f73323          	sd	a5,294(a4) # 818 <freep>
}
 6fa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 728:	0f453503          	ld	a0,244(a0) # 818 <freep>
 ...
 750:	0cc90913          	addi	s2,s2,204 # 818 <freep>
  if(p == (char*)-1)
 754:	5afd                	li	s5,-1
 756:	a88d                	j	7c8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 758:	00000797          	auipc	a5,0x0
 75c:	0c878793          	addi	a5,a5,200 # 820 <base>
 760:	00000717          	auipc	a4,0x0
 764:	0af73c23          	sd	a5,184(a4) # 818 <freep>
 768:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78a:	08a73923          	sd	a0,146(a4) # 818 <freep>
      return (void*)(p + 1);
