...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124a:	44278793          	addi	a5,a5,1090 # 8688 <big.1274>
...
0000000000002236 <bigargtest>:
{
  ...
  close(fd);
    ...
    229e:	2ee78793          	addi	a5,a5,750 # 8588 <args.1863>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3de68693          	addi	a3,a3,990 # 8680 <args.1863+0xf8>
    ...
    22be:	2ce58593          	addi	a1,a1,718 # 8588 <args.1863>
