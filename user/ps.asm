...
main(int argc, char *argv[])
{
  ...
  24:	7a078793          	addi	a5,a5,1952 # fffffffffffff7a0 <__global_pointer$+0xffffffffffffe607>
  28:	00f40533          	add	a0,s0,a5
  2c:	00000097          	auipc	ra,0x0
  30:	418080e7          	jalr	1048(ra) # 444 <pinfo>
  34:	06054463          	bltz	a0,9c <main+0x9c>
  ...
  3c:	8f050513          	addi	a0,a0,-1808 # 928 <malloc+0x146>
  40:	00000097          	auipc	ra,0x0
  44:	6e4080e7          	jalr	1764(ra) # 724 <printf>
  for(i = 0; i < MAX_PS_PROC; i++) {
  48:	77fd                	lui	a5,0xfffff
  4a:	7a078793          	addi	a5,a5,1952 # fffffffffffff7a0 <__global_pointer$+0xffffffffffffe607>
  4e:	00f404b3          	add	s1,s0,a5
  52:	8a040913          	addi	s2,s0,-1888
  56:	00249a13          	slli	s4,s1,0x2
  5a:	41448a33          	sub	s4,s1,s4
    if(psinfo.active[i]) {
      printf("%d \t %s \t %d \t %s\n",
  5e:	400a0a13          	addi	s4,s4,1024
    return "UNKNOWN";
  62:	00001d17          	auipc	s10,0x1
  66:	866d0d13          	addi	s10,s10,-1946 # 8c8 <malloc+0xe6>
  6a:	00001997          	auipc	s3,0x1
  6e:	8fa98993          	addi	s3,s3,-1798 # 964 <malloc+0x182>
    return "UNUSED";
  72:	00001a97          	auipc	s5,0x1
  76:	85ea8a93          	addi	s5,s5,-1954 # 8d0 <malloc+0xee>
    return "ZOMBIE";
  7a:	00001c97          	auipc	s9,0x1
  7e:	886c8c93          	addi	s9,s9,-1914 # 900 <malloc+0x11e>
    return "RUNNING";
  82:	00001c17          	auipc	s8,0x1
  86:	876c0c13          	addi	s8,s8,-1930 # 8f8 <malloc+0x116>
    return "RUNNABLE";
  8a:	00001b97          	auipc	s7,0x1
  8e:	85eb8b93          	addi	s7,s7,-1954 # 8e8 <malloc+0x106>
    return "SLEEPING";
  92:	00001b17          	auipc	s6,0x1
  96:	846b0b13          	addi	s6,s6,-1978 # 8d8 <malloc+0xf6>
  9a:	a0a1                	j	e2 <main+0xe2>
    fprintf(2, "%s: pinfo failed...\n", argv[0]);
  9c:	6090                	ld	a2,0(s1)
  9e:	00001597          	auipc	a1,0x1
  a2:	87258593          	addi	a1,a1,-1934 # 910 <malloc+0x12e>
  a6:	4509                	li	a0,2
  a8:	00000097          	auipc	ra,0x0
  ac:	64e080e7          	jalr	1614(ra) # 6f6 <fprintf>
    exit(1);
  b0:	4505                	li	a0,1
  b2:	00000097          	auipc	ra,0x0
  b6:	2ea080e7          	jalr	746(ra) # 39c <exit>
      printf("%d \t %s \t %d \t %s\n",
  ba:	00001617          	auipc	a2,0x1
  be:	84e60613          	addi	a2,a2,-1970 # 908 <malloc+0x126>
  c2:	00249713          	slli	a4,s1,0x2
  c6:	9752                	add	a4,a4,s4
  c8:	3006a683          	lw	a3,768(a3)
  cc:	00001517          	auipc	a0,0x1
  d0:	88450513          	addi	a0,a0,-1916 # 950 <malloc+0x16e>
  d4:	00000097          	auipc	ra,0x0
  d8:	650080e7          	jalr	1616(ra) # 724 <printf>
  for(i = 0; i < MAX_PS_PROC; i++) {
  dc:	0491                	addi	s1,s1,4
  de:	03248f63          	beq	s1,s2,11c <main+0x11c>
    if(psinfo.active[i]) {
  e2:	86a6                	mv	a3,s1
  e4:	409c                	lw	a5,0(s1)
  e6:	dbfd                	beqz	a5,dc <main+0xdc>
      printf("%d \t %s \t %d \t %s\n",
  e8:	1004a583          	lw	a1,256(s1)
  switch(state) {
  ec:	2004a703          	lw	a4,512(s1)
  f0:	4795                	li	a5,5
  f2:	02e7e163          	bltu	a5,a4,114 <main+0x114>
  f6:	2004e783          	lwu	a5,512(s1)
  fa:	078a                	slli	a5,a5,0x2
  fc:	97ce                	add	a5,a5,s3
  fe:	439c                	lw	a5,0(a5)
 100:	97ce                	add	a5,a5,s3
 102:	8782                	jr	a5
    return "SLEEPING";
 104:	865a                	mv	a2,s6
 106:	bf75                	j	c2 <main+0xc2>
    return "RUNNABLE";
 108:	865e                	mv	a2,s7
 10a:	bf65                	j	c2 <main+0xc2>
    return "RUNNING";
 10c:	8662                	mv	a2,s8
 10e:	bf55                	j	c2 <main+0xc2>
    return "ZOMBIE";
 110:	8666                	mv	a2,s9
 112:	bf45                	j	c2 <main+0xc2>
    return "UNKNOWN";
 114:	866a                	mv	a2,s10
 116:	b775                	j	c2 <main+0xc2>
    return "UNUSED";
 118:	8656                	mv	a2,s5
 11a:	b765                	j	c2 <main+0xc2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 494:	4f850513          	addi	a0,a0,1272 # 988 <digits>
 498:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 560:	42cb8b93          	addi	s7,s7,1068 # 988 <digits>
 ...
 6a0:	2e490913          	addi	s2,s2,740 # 980 <malloc+0x19e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 768:	23c7b783          	ld	a5,572(a5) # 9a0 <freep>
...
malloc(uint nbytes)
{
 ...
 80a:	19a53503          	ld	a0,410(a0) # 9a0 <freep>
 ...
 832:	17290913          	addi	s2,s2,370 # 9a0 <freep>
  if(p == (char*)-1)
 836:	5afd                	li	s5,-1
 838:	a88d                	j	8aa <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 83a:	00000797          	auipc	a5,0x0
 83e:	16e78793          	addi	a5,a5,366 # 9a8 <base>
 842:	00000717          	auipc	a4,0x0
 846:	14f73f23          	sd	a5,350(a4) # 9a0 <freep>
 84a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 86c:	12a73c23          	sd	a0,312(a4) # 9a0 <freep>
      return (void*)(p + 1);
